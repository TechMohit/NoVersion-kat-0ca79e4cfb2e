...
import cms.co.in.kat.adapters.JudgeCaseListAdapter;
...
import static cms.co.in.kat.activity.Judgement.multiListCase;

public class JudgeCaseList extends AppCompatActivity implements View.OnClickListener {


    private RecyclerView rvSittingList;
    private JudgeCaseListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_judge_case_list);
        ...
        if (caseType == Constant.MULTI_CASE_SEARCH) {
            adapter = new JudgeCaseListAdapter(this, multiListCase);
        }
        Log.d("loadtes","leng"+multiListCase.size());
        if(multiListCase.size()<10)
        {
...
*/
    ...
    private void footerListner() {
        ...
        footerCaseSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(JudgeCaseList.this, CaseTrack.class);
                startActivity(i);
            }
        });
        ...
        footerJudgment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(JudgeCaseList.this, Judgement.class);
                startActivity(i);
            }
        });
    }
    ...
    public void onClick(View v) {
        ...
        if (ShowDilog.internet) {
            ...
            GeneralUtilities.showMessage(JudgeCaseList.this, parentLayout, getResources().getString(R.string.internet));
    ...
    private void volly(final String tag, int get, String link, HashMap<String, String> params) {
        ...
        v.makeStringReq(tag, get, link, params, new VolleyListner() {
            ...
            public void onVolleyRespondString(int result, String response) {
                ...
                if (tag == urlConst.CASE_SEARCH_TAG) {
                    ...
                    if (result == 1) {
                        ...
                        Log.d("loadtest4","i:"+i+"j:"+j);
                        clicknxt ="last";
                        two.setVisibility(View.GONE);
                        if ((i == 10) & (j == 20)) {
                            Log.d("loadtest25","fdfdfd");
                            two.setVisibility(View.VISIBLE);
                        }
                        GeneralUtilities.showMessage(JudgeCaseList.this, parentLayout, "No Record Found");
            ...
            public void onVolleyError(String result) {
                ...
                GeneralUtilities.showMessage(JudgeCaseList.this, parentLayout, "Please Try Again");
            }
        });
    }
}
