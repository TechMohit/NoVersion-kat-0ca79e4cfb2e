...
public class Judgement extends AppCompatActivity {
    ...
    private void initAdapter() {
        ...
        adapter = new ArrayAdapter<Object>(Judgement.this, android.R.layout.simple_dropdown_item_1line, data);
        adapter2 = new ArrayAdapter<Object>(Judgement.this, android.R.layout.simple_dropdown_item_1line, data);
...
//        et1.setAdapter(arrayAdapter);
        ...
        ArrayAdapter<String> arrayAdapterBranch = new ArrayAdapter<>(Judgement.this, android.R.layout.simple_dropdown_item_1line, branch);
        spBranch.setAdapter(arrayAdapterBranch);
        ArrayAdapter<String> arrayAdapterCaseType = new ArrayAdapter<>(Judgement.this, android.R.layout.simple_dropdown_item_1line, casetype);
        spCaseType.setAdapter(arrayAdapterCaseType);
        ArrayAdapter<String> arrayAdapterSection = new ArrayAdapter<>(Judgement.this, android.R.layout.simple_dropdown_item_1line, SPINNERLIST);
        spSection.setAdapter(arrayAdapterSection);
        ArrayAdapter<String> arrayAdapterDistrict = new ArrayAdapter<>(Judgement.this, android.R.layout.simple_dropdown_item_1line, district);
        spDistrict.setAdapter(arrayAdapterDistrict);
        ArrayAdapter<String> arrayAdapterCourthall = new ArrayAdapter<>(Judgement.this, android.R.layout.simple_dropdown_item_1line, courtHall);
            ...
            public void onClick(View v) {
                ...
                if (ShowDilog.internet) {
                    ...
                    if (msection.equalsIgnoreCase("") && mcourthall.equalsIgnoreCase("") && mbranch.equalsIgnoreCase("") && mcaseType.equalsIgnoreCase("")
                        ...
                        GeneralUtilities.showMessage(Judgement.this, parentLayout, "Please Select one value");

                    } else if (mappellantName.equalsIgnoreCase("") && mrespondentName.equalsIgnoreCase("") && madvocateName.equalsIgnoreCase("")) {
                        GeneralUtilities.showMessage(Judgement.this, parentLayout, "Enter Appellant/Respondent/Advocate name");
                    ...
                    GeneralUtilities.showMessage(Judgement.this, parentLayout, getResources().getString(R.string.internet));
                }
            }
        });
            ...
            public void onClick(View v) {
                if (ShowDilog.internet) {
                    ...
                    if (caseno != null && caseno.length() > 1) {
                        ...
                        Intent i = new Intent(Judgement.this, CaseJudgmentInfo.class);
...
//                    expandableLayout1.expand();
        ...
        expand_rev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter<String> arrayAdapter1 = new ArrayAdapter<>(Judgement.this, android.R.layout.simple_dropdown_item_1line, drop1);
        ...
        expand_sale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                et3.setText("");
                et4.setText("");
                ArrayAdapter<String> arrayAdapter1 = new ArrayAdapter<>(Judgement.this, android.R.layout.simple_dropdown_item_1line, drop2);
                et2.setAdapter(arrayAdapter1);
...
//        });
        ...
        spSection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (spBranch.getText().toString().equalsIgnoreCase("Revenue")) {
                    ...
                    ArrayAdapter<String> arrayAdapterSection = new ArrayAdapter<>(Judgement.this,
                    ...
                    GeneralUtilities.showMessage(Judgement.this, parentLayout, "Please select Branch");
                }
            }
        });
        ...
        etDateStart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new GeneralUtilities(Judgement.this).setDate(etDateStart);
        ...
        etDateEnd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new GeneralUtilities(Judgement.this).setDate(etDateEnd);
    ...
    private String validate() {
        ...
        if (et1.getText().toString().equalsIgnoreCase("") || et2.getText().toString().equalsIgnoreCase("") ||
            ...
            GeneralUtilities.showMessage(Judgement.this, parentLayout, "Case Number is Invalid");

        } else if (et3.getText().toString().startsWith("0") || et4.getText().toString().startsWith("0")) {
            GeneralUtilities.showMessage(Judgement.this, parentLayout, "Please Enter a Valid Case Number");

        } else if (year < Integer.parseInt(et4.getText().toString())) {
            GeneralUtilities.showMessage(Judgement.this, parentLayout, "Enter a valid Year");
        ...
        vl.makeStringReq(tag, get, link, params, new VolleyListner() {
            ...
            public void onVolleyRespondString(int result, String response) {
                if ((tag == urlConst.CASE_SEARCH_AUTO_TAG)) {
                    ...
                    Log.d(urlConst.CASE_SEARCH_TAG, "result codejude " + response);
                    if (result == 1) {
                        try {
                        ...
                        GeneralUtilities.showMessage(Judgement.this, parentLayout, response);
            ...
            public void onVolleyError(String result) {
                ...
                GeneralUtilities.showMessage(Judgement.this, parentLayout, "Please Try Again");
    ...
    private void showCaseList() {
        Intent i = new Intent(Judgement.this, JudgeCaseList.class);
