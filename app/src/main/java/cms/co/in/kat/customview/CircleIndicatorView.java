...
//        activeIndicatorPaint.setStrokeWidth(1);
//        activeIndicatorPaint.setAlpha(255);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < indicatorsCount; i++) {
            activeIndicatorPaint.setColor(ContextCompat.getColor(context, R.color.light_white));
            inactiveIndicatorPaint.setColor(ContextCompat.getColor(context, R.color.white));

            if (position == i) {
                canvas.drawCircle(radius + (size * i), radius, radius - (((float) radius / 100) * 18), inactiveIndicatorPaint);

            } else
                canvas.drawCircle(radius + (size * i), radius, radius / 2, activeIndicatorPaint);
